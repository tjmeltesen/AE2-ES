...
test("log modules load", function()
  local entry = require("home.lib.log_entry")
  local buf = require("home.lib.log_ring_buffer")
...
test("log_entry creates valid entry", function()
  local LogEntry = require("home.lib.log_entry")
...
test("log_ring_buffer appends and retrieves", function()
  local LogRingBuffer = require("home.lib.log_ring_buffer")
  local LogEntry = require("home.lib.log_entry")
